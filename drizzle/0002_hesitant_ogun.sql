...
ALTER TABLE "enrollments" ADD CONSTRAINT "enrollments_courses_courses_id_fk" FOREIGN KEY ("courses") REFERENCES "public"."courses"("id") ON DELETE no action ON UPDATE no action;